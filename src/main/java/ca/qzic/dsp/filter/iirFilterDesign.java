...
import static ca.qzic.dsp.filter.iirFilterDesign.FilterType.LP;
...
// by P. Lynn and W. Fuerst (Prentice Hall)
    ...
    private int prototype,freqPoints;
    ...
    public void iirFilterDesign() {
        ...
        public void iirFilterDesign(FilterType type, int order, float ripple, float sampleRate, float fp1, float fp2) {
        // initial (default) settings
        prototype = BUTTERWORTH;
