...
import ca.qzic.dsp.filter.BesselFilterDesign;
import ca.qzic.dsp.filter.FilterCharacteristicsType;
import ca.qzic.dsp.filter.FilterPassType;
import ca.qzic.dsp.filter.IirFilterCoefficients;
import ca.qzic.dsp.math.Complex;
import ca.qzic.dsp.math.PolynomialUtils;
import ca.qzic.dsp.util.ArrayUtils;
